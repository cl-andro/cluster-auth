...
import com.zk.cluster.auth.crypto.SCryptParameters;
import com.zk.cluster.auth.otp.OtpInfo;
import com.zk.cluster.auth.ui.views.EntryHolder;
...
public abstract class ClusterTest {
    ...
    protected ClusterApplicationBase getApp() {
        return (ClusterApplicationBase) InstrumentationRegistry.getInstrumentation().getTargetContext().getApplicationContext();
    }
