...
import com.zk.cluster.auth.ui.IntroActivity;
...
@HiltAndroidTest
@LargeTest
public class IntroTest extends ClusterTest {
    ...
    public void testIntro_Import_Plain() {
        assertFalse(_prefs.isIntroDone());
        Uri uri = getResourceUri("cluster_plain.json");
    ...
    public void testIntro_Import_Encrypted() {
        assertFalse(_prefs.isIntroDone());
        Uri uri = getResourceUri("cluster_encrypted.json");
        Intent resultData = new Intent();
        resultData.setData(uri);
