...
public class ClusterBackupAgent extends BackupAgent {
    private static final String TAG = ClusterBackupAgent.class.getSimpleName();
    ...
    public void onCreate() {
        ...
        AppDatabase appDatabase = ClusterModule.provideAppDatabase(this);
        _auditLogRepository = ClusterModule.provideAuditLogRepository(appDatabase);
    }
