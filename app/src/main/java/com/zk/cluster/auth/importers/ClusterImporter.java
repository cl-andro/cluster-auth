...
import com.zk.cluster.auth.helpers.ContextHelper;
...
import com.zk.cluster.auth.vault.VaultEntryException;
...
public class ClusterImporter extends DatabaseImporter {

    public ClusterImporter(Context context) {
        super(context);
    }
    ...
    public static class EncryptedState extends State {
        ...
        public void decrypt(Context context, DecryptListener listener) {
            Dialogs.showPasswordInputDialog(context, R.string.enter_password_cluster_title, 0, (Dialogs.TextInputListener) password -> {
                List<PasswordSlot> slots = getSlots().findAll(PasswordSlot.class);
