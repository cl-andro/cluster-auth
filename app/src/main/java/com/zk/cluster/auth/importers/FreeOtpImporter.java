...
import com.zk.cluster.auth.ui.tasks.PBKDFTask;
import com.zk.cluster.auth.util.PreferenceParser;
...
public class FreeOtpImporter extends DatabaseImporter {
    ...
    public static class EncryptedState extends State {
        ...
        public void decrypt(Context context, DecryptListener listener) {
            Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Cluster_AlertDialog_Warning)
                    ...
                    .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                        Dialogs.showPasswordInputDialog(context, R.string.enter_password_cluster_title, 0, password -> {
