...
import com.zk.cluster.auth.crypto.KeyStoreHandle;
import com.zk.cluster.auth.crypto.KeyStoreHandleException;
import com.zk.cluster.auth.crypto.MasterKey;
import com.zk.cluster.auth.helpers.BiometricsHelper;
import com.zk.cluster.auth.helpers.EditTextHelper;
import com.zk.cluster.auth.helpers.MetricsHelper;
import com.zk.cluster.auth.helpers.UiThreadExecutor;
import com.zk.cluster.auth.ui.dialogs.Dialogs;
import com.zk.cluster.auth.ui.tasks.PasswordSlotDecryptTask;
...
import com.zk.cluster.auth.vault.slots.Slot;
import com.zk.cluster.auth.vault.slots.SlotException;
import com.zk.cluster.auth.vault.slots.SlotIntegrityException;
import com.zk.cluster.auth.vault.slots.SlotList;
...
public class AuthActivity extends ClusterActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        biometricsButton.setOnClickListener(v -> {
            if (_prefs.isPasswordReminderNeeded()) {
                Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_Cluster_AlertDialog_Warning)
    ...
    private void onInvalidPassword() {
        Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(AuthActivity.this, R.style.ThemeOverlay_Cluster_AlertDialog_Error)
