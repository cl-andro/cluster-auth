...
@AndroidEntryPoint
public abstract class ClusterActivity extends AppCompatActivity implements VaultManager.LockListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set FLAG_SECURE on the window of every ClusterActivity
