...
import com.zk.cluster.auth.helpers.AnimationsHelper;
import com.zk.cluster.auth.helpers.BitmapHelper;
import com.zk.cluster.auth.helpers.DropdownHelper;
import com.zk.cluster.auth.helpers.EditTextHelper;
import com.zk.cluster.auth.helpers.SafHelper;
import com.zk.cluster.auth.helpers.SimpleAnimationEndListener;
import com.zk.cluster.auth.helpers.SimpleTextWatcher;
import com.zk.cluster.auth.helpers.TextDrawableHelper;
import com.zk.cluster.auth.helpers.ViewHelper;
import com.zk.cluster.auth.icons.IconPack;
import com.zk.cluster.auth.icons.IconType;
import com.zk.cluster.auth.otp.GoogleAuthInfo;
import com.zk.cluster.auth.otp.HotpInfo;
import com.zk.cluster.auth.otp.MotpInfo;
import com.zk.cluster.auth.otp.OtpInfo;
...
import com.zk.cluster.auth.otp.YandexInfo;
import com.zk.cluster.auth.ui.dialogs.Dialogs;
import com.zk.cluster.auth.ui.dialogs.IconPickerDialog;
import com.zk.cluster.auth.ui.glide.GlideHelper;
import com.zk.cluster.auth.ui.models.VaultGroupModel;
import com.zk.cluster.auth.ui.tasks.ImportFileTask;
import com.zk.cluster.auth.ui.views.IconAdapter;
...
import com.zk.cluster.auth.vault.VaultGroup;
...
public class EditEntryActivity extends ClusterActivity {
    ...
    private void onSaveError(String msg) {
        Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_Cluster_AlertDialog_Error)
