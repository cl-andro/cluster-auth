...
import com.zk.cluster.auth.SortCategory;
import com.zk.cluster.auth.helpers.BitmapHelper;
import com.zk.cluster.auth.helpers.DropdownHelper;
import com.zk.cluster.auth.helpers.FabMenuHelper;
import com.zk.cluster.auth.helpers.FabScrollHelper;
import com.zk.cluster.auth.helpers.PermissionHelper;
...
import com.zk.cluster.auth.otp.GoogleAuthInfoException;
import com.zk.cluster.auth.otp.OtpInfoException;
import com.zk.cluster.auth.ui.dialogs.Dialogs;
import com.zk.cluster.auth.ui.fragments.preferences.BackupsPreferencesFragment;
import com.zk.cluster.auth.ui.fragments.preferences.PreferencesFragment;
...
public class MainActivity extends ClusterActivity implements EntryListView.Listener, PasswordVaultFragment.Listener, SecretsFragment.Listener, PhoneNumbersFragment.Listener {
   ...
   private void updateErrorCard() {
    ...
    private void showPlaintextExportWarningOptions() {
        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(this, R.style.ThemeOverlay_Cluster_AlertDialog_Warning)
