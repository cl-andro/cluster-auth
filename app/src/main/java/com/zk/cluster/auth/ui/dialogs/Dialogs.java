...
import com.zk.cluster.auth.BackupsVersioningStrategy;
import com.zk.cluster.auth.Preferences;
import com.zk.cluster.auth.R;
import com.zk.cluster.auth.helpers.EditTextHelper;
import com.zk.cluster.auth.helpers.PasswordStrengthHelper;
import com.zk.cluster.auth.helpers.SimpleTextWatcher;
import com.zk.cluster.auth.importers.DatabaseImporter;
import com.zk.cluster.auth.ui.tasks.KeyDerivationTask;
...
public class Dialogs {
    ...
    public static void showDeleteEntriesDialog(Context context, List<VaultEntry> services, DialogInterface.OnClickListener onDelete) {
        ...
        showSecureDialog(new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Cluster_AlertDialog_Warning)
                .setTitle(title)
                .setView(view)
    ...
    public static void showErrorDialog(Context context, String message, CharSequence error, DialogInterface.OnClickListener listener) {
        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Cluster_AlertDialog_Error)
    ...
    public static void showMultiErrorDialog(
        ...
        Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Cluster_AlertDialog_Error)
                .setTitle(title)
                .setMessage(message)
                .setCancelable(false)
                .setIconAttribute(android.R.attr.alertDialogIcon)
    ...
    public static void showPartialGoogleAuthImportWarningDialog(Context context, List<Integer> missingIndexes, int entries, List<CharSequence> scanningErrors, DialogInterface.OnClickListener dismissHandler) {
        ...
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_Cluster_AlertDialog_Warning)
