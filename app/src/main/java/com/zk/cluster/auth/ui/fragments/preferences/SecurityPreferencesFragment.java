...
import com.zk.cluster.auth.PassReminderFreq;
...
import com.zk.cluster.auth.helpers.BiometricSlotInitializer;
import com.zk.cluster.auth.helpers.BiometricsHelper;
import com.zk.cluster.auth.ui.dialogs.Dialogs;
import com.zk.cluster.auth.ui.preferences.SwitchPreference;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        _encryptionPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            if (!_vaultManager.getVault().isEncryptionEnabled()) {
                ...
                Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_Cluster_AlertDialog_Warning)
        ...
        _pinKeyboardPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            ...
            Dialogs.showPasswordInputDialog(requireContext(), R.string.set_password_confirm, R.string.pin_keyboard_description, password -> {
                if (isDigitsOnly(new String(password))) {
                    ...
                    Dialogs.showSecureDialog(new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_Cluster_AlertDialog_Error)
