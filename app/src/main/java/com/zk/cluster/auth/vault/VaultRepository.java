...
public class VaultRepository {
    public static final String FILENAME = "cluster.json";
    public static final String FILENAME_PREFIX_EXPORT = "cluster-export";
    public static final String FILENAME_PREFIX_EXPORT_PLAIN = "cluster-export-plain";
    public static final String FILENAME_PREFIX_EXPORT_URI = "cluster-export-uri";
    public static final String FILENAME_PREFIX_EXPORT_HTML = "cluster-export-html";
