...
# example usage: ./scripts/decrypt.py --input ./app/src/test/resources/com/beemdevelopment/cluster/importers/cluster_encrypted.json
# password: test
...
def main():
    parser = argparse.ArgumentParser(description="Decrypt an Cluster vault")
    parser.add_argument("--input", dest="input", required=True, help="encrypted Cluster vault file")
    parser.add_argument("--output", dest="output", default="-", help="output file ('-' for stdout)")
    args = parser.parse_args()

    # parse the Cluster vault file
